...
ClassCorpus reads people's coursework, so one project-specific expectation
applies: **do not post other people's private material.** Never include real
lecture files, personal data, or anything you lack permission to redistribute in
an issue, pull request, or discussion. Use generated fixtures instead.
...
privately, by contacting [@haixinnn05](https://github.com/haixinnn05) through
the contact details on that GitHub profile. For conduct that violates GitHub's
own terms, you can also use
